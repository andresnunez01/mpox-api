...
export function generateMpoxEmailTemplate(creationDate: Date , lat: number, lng: number, age: number, genre: string): string {
    ...
    <body>
        <div class="container">
            ...
            <div class="content">
                <p><strong>Fecha de registro del infectado:</strong> ${creationDate}</p>
